      ...
      Download App</a>
        ...
        <div className='a_header_bottom '>
          <div className="container ps-0">
            <div className='row '>
            <div className='col-3 m-2 ps-0'>
              <a href="#" className=''>
                <img className="mb-3" src="https://www.snapdeal.com/img/icons/finalFavicon.ico" height="40px"/>
                <snap className='snapdeal text-white'>snapdeal</snap>
              </a>
            </div>
            <div className='col-8 pe-0 ms-4 mt-3 '>
              <form className="a_hform bg-white g-3 ">B</form>
            </div>
